...
if   (search1.value.trim() == '1950-1959') {
...
if   (search2.value.trim() == 'Perdana Menteri Mohammad Natsir') {
        Swal.fire ({
            icon: 'success',
            title: 'K-kok bener?',
...
if   (search3.value.trim() == 'Soekarno') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search5.value.trim() == 'B.J.Habibie') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search6.value.trim() == 'B.J.Habibie') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search7.value.trim() == 'Sjafruddin Prawiranegara') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search8.value.trim() == 'Soeharto') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search9.value.trim() == 'Sistem Parlementer') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
...
if   (search10.value.trim() == 'Tahun 1959-1965') {
        Swal.fire ({
            icon: 'success',
            title: 'Jawaban Anda benar',
